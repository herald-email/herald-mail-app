	...
	if m.showSettings && m.settingsPanel != nil {
		...
		if m.contactSearchMode == "keyword" {
			...
			if m.mouseSelectionMode {
				...
				hints = joinHintSegments("tab: next panel", "drag: select", "y: copy selection", problemReportShortcutHint, "m: mouse mode", "esc: back to contact", "q: quit")
			}
		...
		if m.calendarEdit.Active {
			...
			hints = joinHintSegments(m.primaryTabShortcutHint(), settingsHint, "ctrl+n: new", "e: edit", "D: delete", backLabel, m.commandHint(keyboardScopeGlobal, CommandAppRefresh, "refresh"), m.commandHint(keyboardScopeGlobal, CommandAppQuit, "quit"), "provider-backed")
		} else if m.calendarView == calendarViewSearch {
			...
			hints = joinHintSegments(m.primaryTabShortcutHint(), settingsHint, "tab: rail/main/detail", m.movementHint("calendar", "events"), "ctrl+n: new", "D: delete", "ctrl+u/d: page", "h/l: day", "e: edit", "t: 3-day", "w: week", "a: agenda", "/: search", crossSearchHint, "enter: detail", m.commandHint(keyboardScopeGlobal, CommandAppRefresh, "refresh"), m.commandHint(keyboardScopeGlobal, CommandAppQuit, "quit"), "provider-backed")
		} else if m.calendarView == calendarViewWeek {
			hints = joinHintSegments(m.primaryTabShortcutHint(), settingsHint, "tab: rail/main/detail", m.movementHint("calendar", "events"), "ctrl+n: new", "D: delete", "ctrl+u/d: page", "h/l: week", "e: edit", "t: 3-day", "d: day", "a: agenda", "/: search", crossSearchHint, "enter: detail", m.commandHint(keyboardScopeGlobal, CommandAppRefresh, "refresh"), m.commandHint(keyboardScopeGlobal, CommandAppQuit, "quit"), "provider-backed")
		} else if m.calendarView == calendarViewThreeDay {
			hints = joinHintSegments(m.primaryTabShortcutHint(), settingsHint, "tab: rail/main/detail", m.movementHint("calendar", "events"), "ctrl+n: new", "D: delete", "ctrl+u/d: page", "h/l: 3-day", "e: edit", "w: week", "d: day", "a: agenda", "/: search", crossSearchHint, "enter: detail", m.commandHint(keyboardScopeGlobal, CommandAppRefresh, "refresh"), m.commandHint(keyboardScopeGlobal, CommandAppQuit, "quit"), "provider-backed")
		} else {
			hints = joinHintSegments(m.primaryTabShortcutHint(), settingsHint, "tab: rail/main/detail", m.movementHint("calendar", "events"), "ctrl+n: new", "D: delete", "ctrl+u/d: page", agendaPastHint, "h/l: day", "e: edit", "d: day", "w: week", "t: 3-day", "/: search", crossSearchHint, "enter: detail", m.commandHint(keyboardScopeGlobal, CommandAppRefresh, "refresh"), m.commandHint(keyboardScopeGlobal, CommandAppQuit, "quit"), "provider-backed")
		}
	} else {
