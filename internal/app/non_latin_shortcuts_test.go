...
func TestShortcutKeyPrefersBaseCodeAndPreservesModifiersAndShift(t *testing.T) {
	tests := []struct {
		...
		{name: "associated text shifted ascii letter", msg: tea.KeyPressMsg{Text: "l", Code: 'l', Mod: tea.ModShift}, want: "L"},
		{name: "associated text shifted ascii punctuation", msg: tea.KeyPressMsg{Text: "/", Code: '/', Mod: tea.ModShift}, want: "?"},
		{name: "fallback shifted ascii letter", msg: tea.KeyPressMsg{Code: 'l', Mod: tea.ModShift}, want: "L"},
		{name: "fallback shifted ascii punctuation", msg: tea.KeyPressMsg{Code: '/', Mod: tea.ModShift}, want: "?"},
		{name: "fallback shifted cyrillic alias", msg: tea.KeyPressMsg{Text: "д", Code: 'д', Mod: tea.ModShift}, want: "L"},
