...
func (noopBackend) GetSenderStatistics(folder string) (map[string]*models.SenderStats, error) {
	return nil, nil
}
func (noopBackend) GetEmailsBySender(folder string) (map[string][]*models.EmailData, error) {
	return nil, nil
}
...
func (noopBackend) GetFolderStatus(folders []string) (map[string]models.FolderStatus, error) {
	return nil, nil
}
...
func (noopBackend) FetchEmailBody(folder string, uid uint32) (*models.EmailBody, error) {
	return nil, nil
}
...
func (noopBackend) SearchEmails(folder, query string, bodySearch bool) ([]*models.EmailData, error) {
	return nil, nil
}
func (noopBackend) SearchEmailsCrossFolder(query string) ([]*models.EmailData, error) {
	return nil, nil
}
func (noopBackend) SearchEmailsIMAP(folder, query string) ([]*models.EmailData, error) {
	return nil, nil
}
func (noopBackend) SearchEmailsSemantic(folder, query string, limit int, minScore float64) ([]*models.EmailData, error) {
	return nil, nil
}
func (noopBackend) GetAllMailOnlyView() (*models.VirtualFolderResult, error) { return nil, nil }
...
func (noopBackend) GetEmailsByThread(folder, subject string) ([]*models.EmailData, error) {
	return nil, nil
}
func (noopBackend) SendEmail(to, subject, body, from string) error { return nil }
func (noopBackend) UpdateUnsubscribeHeaders(messageID, listUnsub, listUnsubPost string) error {
	return nil
}
func (noopBackend) CacheBodyText(messageID, bodyText string) error { return nil }
func (noopBackend) StoreEmbedding(messageID string, embedding []float32, hash string) error {
	return nil
}
...
func (noopBackend) StoreEmbeddingChunks(messageID string, chunks []models.EmbeddingChunk) error {
	return nil
}
...
func (noopBackend) GetRecentSubjectsByContact(email string, limit int) ([]string, error) {
	return nil, nil
}
...
func (noopBackend) ListContacts(limit int, sortBy string) ([]models.ContactData, error) {
	return nil, nil
}
func (noopBackend) SearchContacts(query string) ([]models.ContactData, error) { return nil, nil }
func (noopBackend) GetContactEmails(contactEmail string, limit int) ([]*models.EmailData, error) {
	return nil, nil
}
