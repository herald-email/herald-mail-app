...
- Custom pass: the repo xterm.js image harness painted the color chart plus at least two large photo regions in the browser screenshot. This is the repeatable browser-raster regression lane.
...
- Limitation: ttyd proves browser-visible iTerm2 OSC 1337 pixels. Stock ttyd is a smoke lane and can relocate or omit later images; do not treat its gaps as Herald placement regressions. Neither ttyd lane replaces native iTerm2/Ghostty/Kitty for exact placement, scrollback, or stale-raster cleanup.
