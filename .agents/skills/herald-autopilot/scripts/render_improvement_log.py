        ...
        for entry in reversed(entries):
            ...
            lines.extend(
                [
                    ...
                    f"- Degradation-review required runs: {metrics.get('degradation_review_required_runs', 'n/a')}",
                    f"- Degradation-review ready runs: {metrics.get('degradation_review_ready_runs', 'n/a')}",
                    f"- Degradation-review readiness rate: {metrics.get('degradation_review_readiness_rate', 'n/a')}",
