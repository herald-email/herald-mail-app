...
<!-- HERALD_SCREENSHOT id="contacts-main-list" page="contacts" alt="Contacts tab list and detail panels" state="demo mode, 120x40, Contacts tab active" desc="Shows contact list columns, empty or selected detail panel, contact count, and key hints." capture="tmux demo 120x40; ./bin/herald --demo; press 2" -->
...
<!-- HERALD_SCREENSHOT id="contacts-detail" page="contacts" alt="Contact detail with recent emails" state="demo mode, 120x40, contact detail open" desc="Shows selected contact metadata, recent emails, detail focus behavior, and key hints." capture="tmux demo 120x40; ./bin/herald --demo; press 2; press enter" -->

![Contact detail with recent emails](/screenshots/contacts-detail.png)

<!-- HERALD_SCREENSHOT id="contacts-keyword-search" page="contacts" alt="Contacts keyword search mode" state="demo mode, 120x40, keyword search active" desc="Shows slash search prompt, filtered contact list, search text in hints, and clear behavior." capture="tmux demo 120x40; ./bin/herald --demo; press 2; press /; type demo" -->
