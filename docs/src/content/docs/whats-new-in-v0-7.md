...
description: User-facing changes in the v0.7 beta release.
---
...
The first v0.7 beta is a capability release rather than a small patch. This breakdown helps testers decide what to re-check after upgrading from v0.6.
...
- [x] `beta-latest` points at `v0.7.0-beta.1`, and Homebrew installs the same release-built macOS binaries.
