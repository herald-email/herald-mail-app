...
- [x] Tmux captures cover inherited, Herald dark, Herald light, diverse built-ins, Settings Theme, color picker preview, custom override preview, and the minimum-size guard at required sizes.
