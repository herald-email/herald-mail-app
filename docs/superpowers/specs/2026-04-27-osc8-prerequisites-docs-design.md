...
- [x] Add a concise OSC 8 prerequisite/recommendation note to the top-level `README.md` Quick Start area.
- [x] Add a matching note to `docs/src/content/docs/getting-started.md` under `## Requirements`.
- [x] Mention a few common compatible terminals, including iTerm2, Kitty, WezTerm, GNOME Terminal or other VTE-based terminals, and Windows Terminal.
- [x] Link the phrase describing the full compatibility list to `https://github.com/Alhadis/OSC8-Adoption/`.
- [x] Keep the wording clear that OSC 8 support improves clickable terminal links, not that it is required to launch Herald.
...
- [x] `README.md`
- [x] `docs/src/content/docs/getting-started.md`
...
- [x] Review the changed Markdown for accurate links, concise wording, and no broken heading conventions.
- [x] Run a targeted diff review after editing.
